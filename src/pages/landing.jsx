...
const LandingPage = () => {
  ...
  const handleShorten = (e: React.FormEvent) => {
    e.preventDefault();
    if (longUrl) router.push(`/auth?createNew=${encodeURIComponent(longUrl)}`);
  };

  return (
    <div className="flex flex-col items-center max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
      <h2 className="my-8 sm:my-12 lg:my-16 text-2xl sm:text-4xl lg:text-5xl text-gray-900 text-center font-extrabold leading-tight">
        ...
        <Accordion type="single" collapsible className="w-full divide-y divide-gray-200">
          <AccordionItem value="item-1" className="border-none">
            ...
            <AccordionContent className="px-4 sm:px-6 pb-4 text-sm sm:text-base text-gray-700">
              ...
              accessed. It&apos;s a simple yet powerful way to make your links more manageable and shareable.
            </AccordionContent>
          </AccordionItem>
          <AccordionItem value="item-2" className="border-none">
            ...
            <AccordionContent className="px-4 sm:px-6 pb-4 text-sm sm:text-base text-gray-700">
              ...
              analytics, and customize your short URLs. With an account, you&apos;ll have access to additional features and be able to track the performance of your shortened links over time.
            </AccordionContent>
          </AccordionItem>
