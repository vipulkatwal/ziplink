...
const LandingPage = () => {
  ...
  return (
    <div className="flex flex-col items-center max-w-4xl mx-auto px-4">
      <h2 className="my-10 sm:my-16 text-3xl sm:text-6xl lg:text-5xl text-gray-900 text-center font-extrabold">
        ...
        <div className="flex items-center gap-2">
          <div className="relative flex-grow">
            <Input
              ...
              className="h-12 pl-4 pr-4 rounded-xl text-base bg-gray-800 border-gray-600 text-white placeholder-gray-400"
            />
          </div>
          <Button
            type="submit"
      ...
      <div className="w-full mt-20 rounded-lg overflow-hidden shadow-sm">
        <Accordion type="single" collapsible className="w-full divide-y divide-gray-200">
          <AccordionItem value="item-1" className="border-none">
            <AccordionTrigger className="px-6 py-4 text-lg font-semibold text-gray-800  transition-colors ">
              How does the Ziplink URL shortener work?
            </AccordionTrigger>
            <AccordionContent className="px-6 pb-4 text-gray-700">
              When you enter a long URL, our system generates a shorter version of
              that URL. This shortened URL redirects to the original long URL when
              accessed. Its&rsquo; a simple yet powerful way to make your links more manageable and shareable.
            </AccordionContent>
          </AccordionItem>
          <AccordionItem value="item-2" className="border-none">
            <AccordionTrigger className="px-6 py-4 text-lg font-semibold text-gray-800">
